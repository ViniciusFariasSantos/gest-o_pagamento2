...
public class Titulo {
	...
	@Size(max =  60, message = "Error: A descrição não pode conter mais que 60 caracteres")
	...
	@NotNull(message= "Error: Valor é obrigatório")
	...
	public StatusTotal getStatus() {
		return status;
	}
	public void setStatus(StatusTotal status) {
		this.status = status;
	}
